...
JNIEXPORT void JNICALL Java_com_intel_oap_unsafe_PersistentMemoryPlatform_initializeKmem
  (JNIEnv *, jclass) {
...
JNIEXPORT void JNICALL Java_com_intel_oap_unsafe_PersistentMemoryPlatform_setNUMANode
