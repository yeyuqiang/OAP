...
private[spark] class DiskStore(
  ...
  private val dataStore = {
    ...
    if (isDriver) {
      ...
      // PMemBlockPlatform.initialize("/dev/shm/pmemdb-" + executorId, 2097152L, 4294967296L)
      val properties = new java.util.Properties()
      properties.setProperty("totalSize", "4294967296")
      properties.setProperty("chunkSize", "2097152")
      properties.setProperty("metaStore", "memkind")
      properties.setProperty("storetype", "memkind")
